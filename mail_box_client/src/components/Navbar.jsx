  ...
  return (
    <div className="w-full fixed top-0 left-0 right-0 bg-gray-100 shadow-sm z-50 px-6 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3 ml-4">
        ...
        <span className="text-gray-800 font-medium">Ankit Roy</span>

        <button className="flex items-center text-gray-800 hover:bg-gray-400 px-4 py-2 rounded cursor-pointer space-x-2">
